...
CREATE TABLE `core_client` (
  ...
  `services_required` longtext NOT NULL,
  `created_at` datetime(6) NOT NULL,
  `updated_at` datetime(6) NOT NULL,
  `created_by_id` bigint NOT NULL,
  PRIMARY KEY (`id`),
  KEY `core_client_created_by_id_943b522a_fk_core_user_id` (`created_by_id`),
  CONSTRAINT `core_client_created_by_id_943b522a_fk_core_user_id` FOREIGN KEY (`created_by_id`) REFERENCES `core_user` (`id`)
...
-- Dump completed on 2025-07-22 12:07:08
